...
import { Zap, Github, Download, Monitor, Smartphone } from "lucide-react";
...
export const Navbar: React.FC<NavbarProps> = ({ orientation, setOrientation }) => {
  return (
    <motion.nav
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-900 hover:bg-gray-700 text-white rounded-lg transition-all text-[12px] font-bold"
        >
